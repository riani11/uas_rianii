...
<html lang="en">
    <head>
        ...
        <title>UAS RIANI</title>
    </head>
    <body>
        <div class="container">
            <div id="message">
            </div>
            <h1 class="mt-4 mb-4 text-center text-danger">Peminjaman Ruangan</h1>
            <span id="message"></span>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col col-sm-9">Data peminjam</div>
                    ...
                    <form method="post" id="sample_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date  " name="Tanggal Pinjam" id="Tanggal_Pinjam" class="form-control" />
                                <span id="error" class="text-danger"></span>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">No Hp</label>
                                <input type="number" name="No Hp" id="age" class="form-control" />
            ...
            $.ajax({
                    ...
                    success: function(response) { 
                        ...
                        for (var i = 0; i < json.length; i++) {
                            var sub_array = {
                                'name' : json[i].name,
                                'Tanggal_Pinjam' : json[i].Tanggal_Pinjam,
                                'No_Hp' : json[i].No_Hp,
